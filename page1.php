...
<body>
    ...
    <form action="page2.php" method="get">
        <fieldset>
            ...
            <input type="radio" name="color" id="red" value="Red" title="Computer Gimic">
            <label for="red">Red</label><br>
            <input type="radio" name="color" id="green" value="Green" title="Computer Gimic">
            <label for="green">Green</label><br>
            <input type="radio" name="color" id="blue" value="Blue" title="Computer Gimic">
